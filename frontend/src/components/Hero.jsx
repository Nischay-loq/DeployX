        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16 animate-slide-up" style={{ animationDelay: '0.3s' }}>
            ...
            <a
              ...
              download
              className="btn-outline group bg-white/5 border-white/20 text-white hover:bg-white hover:text-gray-900 w-full sm:w-auto min-w-[180px] flex items-center justify-center"
            >
